/** GENERATED FILE **/
/** Generated by: ginoc at 9/11/2019 2:47:32 PM **/
/** Restricted to types: Topic|Subscription|Bundle|Patient|Encounter|Practitioner|Observation|CapabilityStatement|OperationOutcome|Group **/
/**
...
/**
 * Represents a defined collection of entities that may be discussed or acted upon collectively but which are not expected to act collectively, and are not formally or legally recognized; i.e. a collection of entities that isn't an Organization.
 * From: c:/git/fhir\publish\group.profile.canonical.json
 */
export interface Group extends DomainResource {
	...
	actual: boolean;
	/**
	 * May contain extended information for property: 'actual'
	 */
	_actual?: Element;
	/**
	...
	/**
	 * May contain extended information for property: 'characteristic'
	 */
	...
	/**
	 * May contain extended information for property: 'managingEntity'
	 */
	_managingEntity?: Element;
	/**
	 * Identifies the resource instances that are members of the group.
	 */
	member?: GroupMember[];
	/**
	 * May contain extended information for property: 'member'
	 */
	_member?: Element[];
	/**
	...
	/**
	 * May contain extended information for property: 'quantity'
	 */
	_quantity?: Element;
	/**
 ...
 * From: c:/git/fhir\publish\group.profile.canonical.json
 */
export interface GroupCharacteristic extends Element {
	/**
	...
	exclude: boolean;
	/**
	 * May contain extended information for property: 'exclude'
	 */
	_exclude?: Element;
	/**
 ...
 * From: c:/git/fhir\publish\group.profile.canonical.json
 */
export interface GroupMember extends Element {
	/**
	 * A reference to the entity that is a member of the group. Must be consistent with Group.type. If the entity is another group, then the type must be the same.
	 */
	entity: Reference;
	/**
	 * May contain extended information for property: 'entity'
	 */
	_entity?: Element;
	/**
	...
	inactive?: boolean;
	/**
	 * May contain extended information for property: 'inactive'
	 */
	_inactive?: Element;
	/**
...
/**
 * A collection of error, warning, or information messages that result from a system action.
 * From: c:/git/fhir\publish\operationoutcome.profile.canonical.json
 */
...
interface OperationOutcomeCodes_Interface {
	 ...
	 */
	UPDATE_MULTIPLE_MATCHES: Coding,
};
/**
 * Operation Outcome codes used by FHIR test servers (see Implementation file translations.xml)
 */
export const OperationOutcomeCodes: OperationOutcomeCodes_Interface = {
	DELETE_MULTIPLE_MATCHES: OperationOutcomeCodes_DELETE_MULTIPLE_MATCHES,
	MSG_AUTH_REQUIRED: OperationOutcomeCodes_MSG_AUTH_REQUIRED,
	MSG_BAD_FORMAT: OperationOutcomeCodes_MSG_BAD_FORMAT,
	MSG_BAD_SYNTAX: OperationOutcomeCodes_MSG_BAD_SYNTAX,
	MSG_CANT_PARSE_CONTENT: OperationOutcomeCodes_MSG_CANT_PARSE_CONTENT,
	MSG_CANT_PARSE_ROOT: OperationOutcomeCodes_MSG_CANT_PARSE_ROOT,
	MSG_CREATED: OperationOutcomeCodes_MSG_CREATED,
	MSG_DATE_FORMAT: OperationOutcomeCodes_MSG_DATE_FORMAT,
	MSG_DELETED: OperationOutcomeCodes_MSG_DELETED,
	MSG_DELETED_DONE: OperationOutcomeCodes_MSG_DELETED_DONE,
	MSG_DELETED_ID: OperationOutcomeCodes_MSG_DELETED_ID,
	MSG_DUPLICATE_ID: OperationOutcomeCodes_MSG_DUPLICATE_ID,
	MSG_ERROR_PARSING: OperationOutcomeCodes_MSG_ERROR_PARSING,
	MSG_ID_INVALID: OperationOutcomeCodes_MSG_ID_INVALID,
	MSG_ID_TOO_LONG: OperationOutcomeCodes_MSG_ID_TOO_LONG,
	MSG_INVALID_ID: OperationOutcomeCodes_MSG_INVALID_ID,
	MSG_JSON_OBJECT: OperationOutcomeCodes_MSG_JSON_OBJECT,
	MSG_LOCAL_FAIL: OperationOutcomeCodes_MSG_LOCAL_FAIL,
	MSG_NO_EXIST: OperationOutcomeCodes_MSG_NO_EXIST,
	MSG_NO_MATCH: OperationOutcomeCodes_MSG_NO_MATCH,
	MSG_NO_MODULE: OperationOutcomeCodes_MSG_NO_MODULE,
	MSG_NO_SUMMARY: OperationOutcomeCodes_MSG_NO_SUMMARY,
	MSG_OP_NOT_ALLOWED: OperationOutcomeCodes_MSG_OP_NOT_ALLOWED,
	MSG_PARAM_CHAINED: OperationOutcomeCodes_MSG_PARAM_CHAINED,
	MSG_PARAM_INVALID: OperationOutcomeCodes_MSG_PARAM_INVALID,
	MSG_PARAM_MODIFIER_INVALID: OperationOutcomeCodes_MSG_PARAM_MODIFIER_INVALID,
	MSG_PARAM_NO_REPEAT: OperationOutcomeCodes_MSG_PARAM_NO_REPEAT,
	MSG_PARAM_UNKNOWN: OperationOutcomeCodes_MSG_PARAM_UNKNOWN,
	MSG_RESOURCE_EXAMPLE_PROTECTED: OperationOutcomeCodes_MSG_RESOURCE_EXAMPLE_PROTECTED,
	MSG_RESOURCE_ID_FAIL: OperationOutcomeCodes_MSG_RESOURCE_ID_FAIL,
	MSG_RESOURCE_ID_MISMATCH: OperationOutcomeCodes_MSG_RESOURCE_ID_MISMATCH,
	MSG_RESOURCE_ID_MISSING: OperationOutcomeCodes_MSG_RESOURCE_ID_MISSING,
	MSG_RESOURCE_NOT_ALLOWED: OperationOutcomeCodes_MSG_RESOURCE_NOT_ALLOWED,
	MSG_RESOURCE_REQUIRED: OperationOutcomeCodes_MSG_RESOURCE_REQUIRED,
	MSG_RESOURCE_TYPE_MISMATCH: OperationOutcomeCodes_MSG_RESOURCE_TYPE_MISMATCH,
	MSG_SORT_UNKNOWN: OperationOutcomeCodes_MSG_SORT_UNKNOWN,
	MSG_TRANSACTION_DUPLICATE_ID: OperationOutcomeCodes_MSG_TRANSACTION_DUPLICATE_ID,
	MSG_TRANSACTION_MISSING_ID: OperationOutcomeCodes_MSG_TRANSACTION_MISSING_ID,
	MSG_UNHANDLED_NODE_TYPE: OperationOutcomeCodes_MSG_UNHANDLED_NODE_TYPE,
	MSG_UNKNOWN_CONTENT: OperationOutcomeCodes_MSG_UNKNOWN_CONTENT,
	MSG_UNKNOWN_OPERATION: OperationOutcomeCodes_MSG_UNKNOWN_OPERATION,
	MSG_UNKNOWN_TYPE: OperationOutcomeCodes_MSG_UNKNOWN_TYPE,
	MSG_UPDATED: OperationOutcomeCodes_MSG_UPDATED,
	MSG_VERSION_AWARE: OperationOutcomeCodes_MSG_VERSION_AWARE,
	MSG_VERSION_AWARE_CONFLICT: OperationOutcomeCodes_MSG_VERSION_AWARE_CONFLICT,
	MSG_VERSION_AWARE_URL: OperationOutcomeCodes_MSG_VERSION_AWARE_URL,
	MSG_WRONG_NS: OperationOutcomeCodes_MSG_WRONG_NS,
	SEARCH_MULTIPLE: OperationOutcomeCodes_SEARCH_MULTIPLE,
	SEARCH_NONE: OperationOutcomeCodes_SEARCH_NONE,
	UPDATE_MULTIPLE_MATCHES: OperationOutcomeCodes_UPDATE_MULTIPLE_MATCHES,
}
/*
 * ValueSet alias for http://hl7.org/fhir/ValueSet/operation-outcome
 */
export const OperationOutcomeIssueDetailsValues = OperationOutcomeCodes;
/**
 * Code Values for the OperationOutcomeIssue.code field
 */
export enum OperationOutcomeIssueCodeCodes {
	ERROR = "Error",
}
/**
 * Code Values for the OperationOutcomeIssue.severity field
 */
 ...
 * From: c:/git/fhir\publish\operationoutcome.profile.canonical.json
 */
export interface OperationOutcomeIssue extends Element {
	/**
	...
	/**
	 * May contain extended information for property: 'details'
	 */
	_details?: Element;
	/**
	...
	diagnostics?: string;
	/**
	 * May contain extended information for property: 'diagnostics'
	 */
	...
	severity: code;
	/**
	 * May contain extended information for property: 'severity'
	 */
	_severity?: Element;
}
/**
