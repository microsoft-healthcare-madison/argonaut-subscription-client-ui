/** GENERATED FILE on: 7/22/2019 10:45:22 AM **/
...
export module fhir {
   ...
   */
  interface ModuleMetadata extends Element {
    /**
   ...
   * From: subscription-spreadsheet.xml
   */
  interface SubscriptionChannelPayload extends Element {
    /**
   ...
   * From: subscription-spreadsheet.xml
   */
  interface SubscriptionFilterBy extends Element {
    /**
   ...
   */
  interface Topic extends DomainResource {
    /**
   ...
   * From: topic-spreadsheet.xml
   */
  interface TopicCanFilterBy extends Element {
    /**
   ...
   * From: topic-spreadsheet.xml
   */
  interface TopicResourceTrigger extends Element {
    /**
   ...
   * From: topic-spreadsheet.xml
   */
  interface TopicResourceTriggerQueryCriteria extends Element {
    /**
