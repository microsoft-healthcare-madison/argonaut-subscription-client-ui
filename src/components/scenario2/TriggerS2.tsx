...
/** Component representing the Scenario 2 Trigger Card */
export default function TriggerS2(props: TriggerS2Props) {
  ...
  async function sendEncounter() {
    ...
    switch (selectedPatient) {
      case '_sequential':
          ...
          patientRef = props.groupPatientIds[lastPatientIndexRef.current];
        break;
      case '_random':
          let index: number = Math.floor(Math.random() * props.groupPatientIds.length);
          patientRef = props.groupPatientIds[index];
        break;
      default:
    ...
    <DataCard
      ...
      <FormGroup
        ...
        <HTMLSelect
          ...
          {props.groupPatientIds.map((value) => (
